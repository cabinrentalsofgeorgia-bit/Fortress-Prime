# Matter Command Center - 7IL Case II
...
| Wilson Pruitt email Batch 001 intake kit | `docs/operational/fortress-legal/matter-control/case-ii-2026-05-02/evidence-traceability/wilson-pruitt-email-batch-001-intake-kit-7il-ndga-ii-2026-05-03.md` | First executable batch controls for source drop, hash manifest, attachment manifest, privilege queue, and issue tagging |
| Wilson Pruitt source-drop audit | `docs/operational/fortress-legal/matter-control/case-ii-2026-05-02/evidence-traceability/wilson-pruitt-email-batch-001-source-drop-audit-7il-ndga-ii-2026-05-03.md` | Per-folder readiness gate before source manifests are generated |
