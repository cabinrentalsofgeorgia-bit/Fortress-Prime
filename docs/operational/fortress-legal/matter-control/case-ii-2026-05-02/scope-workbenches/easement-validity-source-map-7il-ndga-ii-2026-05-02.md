...
| GNRR crossing agreement extract | `/mnt/fortress_nas/Corporate_Legal/Business_Legal/7il-v-knight-ndga-ii/filings/outgoing/source-extracts/CASE-I-Exh-L_pages-11-25_GNRR-0184_Knight_Crossing_MP386.3.pdf` | `63713a2c28599440fa53064e68535dd198aa1d46f094d1f5cee1eaa03bb2d0a9` | Pages 11-25 extracted from Exhibit L; source for Georgia Northeastern Railroad / Georgia DOT lease and MP 386.3 crossing-license terms. |
| DOT / railroad right-of-way source index | `scope-workbenches/dot-railroad-right-of-way-source-index-7il-ndga-ii-2026-05-02.md` | Repo-safe companion index | Official public corroboration and records-pull controls for the GDOT/GNRR right-of-way gate. |
...
| Railroad crossing | Exhibit I and the extracted GNRR agreement tie crossing use to a September 1, 2016 Private Road Grade Crossing Agreement with Georgia Northeastern Railroad Company LLC. The GNRR agreement states the railroad leases relevant railroad-purpose property from Georgia DOT. Official GDOT/FRA public materials corroborate the Blue Ridge to McCaysville GNRR segment as GDOT-owned rail-line context. | Crossing agreement and public-source index now pinned; underlying DOT/right-of-way lease, title map, and current railroad-control records still need to be pulled. |
...
| P1 | Georgia DOT / railroad right-of-way ownership records for the crossing area | Tests operator theory that Knight did not own the crossing/right-of-way itself; DOT / railroad source index now controls the records-request targets. |
...
1. Use the pinned GNRR crossing-agreement extract and DOT / railroad source index; pull the underlying DOT/railroad right-of-way lease, title/map records, MP 386.3 crossing file, and current railroad-control records.
