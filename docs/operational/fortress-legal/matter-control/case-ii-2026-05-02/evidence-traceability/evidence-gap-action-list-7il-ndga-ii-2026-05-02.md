...
|---:|---|---|---|---|---|
| P1 | Exhibit G - 2025 River Heights Inspection not curated into complaint exhibits | Related inspection-comments spreadsheet has been extracted into privileged NAS staging, but the answer/Rule 12/counsel package still needs the actual source-verified 2025 River Heights report. | Locate/copy the actual 2025 River Heights inspection into privileged staging first, then curate as Exhibit G only after source and privilege review. | Operator / Codex | Open - spreadsheet lead found |
