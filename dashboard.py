...
st.set_page_config(
    page_title="Fortress Legal Command v4",
    page_icon="🛡️",
    layout="wide"
)

# Debugging: Print to screen so we KNOW this is the new file
print("--- LOADING DASHBOARD.PY (NEW FILE) ---")
...
try:
    ...
    # STRICTLY CLEAN CONNECTION - NO PROXY
