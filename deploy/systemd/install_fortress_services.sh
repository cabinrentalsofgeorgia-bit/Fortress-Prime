...
install -m 0755 "${SYSTEMD_DIR}/run-fortress-arq-worker.sh" /usr/local/bin/run-fortress-arq-worker.sh
...
install -m 0644 "${SYSTEMD_DIR}/fortress-arq-worker.service" /etc/systemd/system/fortress-arq-worker.service
...
systemctl enable fortress-backend.service fortress-dashboard.service fortress-arq-worker.service fortress-event-consumer.service fortress-channex-egress.service fortress-deadline-sweeper.timer
systemctl restart fortress-backend.service fortress-dashboard.service fortress-arq-worker.service fortress-event-consumer.service fortress-channex-egress.service
...
systemctl --no-pager --full status fortress-arq-worker.service
