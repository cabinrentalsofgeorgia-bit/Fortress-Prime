...
Recovered from git history so live environments stamped to this revision can be
inspected and reasoned about safely.
"""
...
down_revision: Union[str, Sequence[str], None] = "a9c1e4f8b2d0"
